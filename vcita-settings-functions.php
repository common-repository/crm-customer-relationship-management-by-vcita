...
function vcita_admin_actions() {
  if (function_exists('add_menu_page')) {
    add_menu_page(__(VCITA_WIDGET_MENU_NAME, 'vcita'),
        ...
        plugins_url(VCITA_WIDGET_UNIQUE_ID.'/images/settings.svg'));
  ...
  ?>
    <script type='text/javascript'>
      jQuery(function ($) {  
        ...
        $('#switch-email')
          .click(function(){
            var callbackURL = "<?php echo $url = get_admin_url('', '', 'admin') . 'admin.php?page='.VCITA_WIDGET_UNIQUE_ID.'/vcita-callback.php' ?>";
            var new_location = "https://" + "<?php echo VCITA_CHANGE_EMAIL_PATH.'?callback=' ?>" + encodeURIComponent(callbackURL) + "&invite="+"<?php echo VCITA_WIDGET_INVITE_CODE ?>"+"&lang="+"<?php echo get_locale() ?>"; 
            window.location = new_location;
           });      
        ...
        $('#scheduling-settings')
          .click(function(e){
            ...
            var callbackURL = "<?php echo $url = get_admin_url('', '', 'admin') . 'admin.php?page='.VCITA_WIDGET_UNIQUE_ID.'/vcita-callback.php' ?>";
            var new_location = "https://" + "<?php echo VCITA_SCHEDULING_PATH.'?callback=' ?>" + encodeURIComponent(callbackURL) + "&invite="+"<?php echo VCITA_WIDGET_INVITE_CODE ?>"+"&lang="+"<?php echo get_locale() ?>"; 
        ...
        $('#test-drive')
          .click(function(){
            var callbackURL = "<?php echo $url = get_admin_url('', '', 'admin') . 'admin.php?page='.VCITA_WIDGET_UNIQUE_ID.'/vcita-callback.php' ?>";
            if ($(this).data().demo) {
              var new_location = "https://" + "<?php echo VCITA_SCHEDULING_TEST_DRIVE_DEMO_PATH.'?callback=' ?>" + encodeURIComponent(callbackURL) + "&invite="+"<?php echo VCITA_WIDGET_INVITE_CODE ?>"+"&lang="+"<?php echo get_locale() ?>"; 
            }
            else {
              var new_location = "https://" + "<?php echo VCITA_SCHEDULING_TEST_DRIVE_PATH.'?callback=' ?>" + encodeURIComponent(callbackURL) + "&invite="+"<?php echo VCITA_WIDGET_INVITE_CODE ?>"+"&lang="+"<?php echo get_locale() ?>"; 
            }
        ...
        $('#switch-account')
          .click(function(ev){
            ev.preventDefault();
            var callbackURL = "<?php echo $url = get_admin_url('', '', 'admin') . 'admin.php?page='.VCITA_WIDGET_UNIQUE_ID.'/vcita-callback.php' ?>";
            var new_location = "https://" + "<?php echo VCITA_LOGIN_PATH.'?callback=' ?>" + encodeURIComponent(callbackURL) + "&invite="+"<?php echo VCITA_WIDGET_INVITE_CODE ?>"+"&lang="+"<?php echo get_locale() ?>"+"&login=true"; 
            window.location = new_location;
          });          
    ...
    <div class="wrap vcita-new-wrap">
      <h2 class="vcita-admin-title">
        ...
        <a target="_blank" href="https://www.vcita.com?invite=wp-v-crm&o=wp-crm" class="vcita-logo"></a>
      </h2>
        ...
        <div class="vcita-box-content">
          ...
          <div class="vcita-row">
            ...
            <span class="vcita-preview">
              <?php if ($first_time): ?>
                <a class="preview" href="https://www.vcita.com/integrations/wordpress/active_engage_preview?uid=252a0a71f9a46f20&ver=2">Preview &amp; Edit</a>
              <?php else: ?>
          ...
          <div class="vcita-row">
            ...
            <span class="vcita-preview">
              <?php if ($first_time): ?>
                <a class="preview" href="https://www.vcita.com/contact_form?v=252a0a71f9a46f20&ver=2" target="_blank">Preview &amp; Edit</a>
              <?php else: ?>
      ...
      <div class="vcita-info-box">
        ...
        -->
        <a href="https://support.vcita.com/" target="_blank" class="vcita-need-help last">
    ...
    <script type="text/html" id="settings-iframe">
      <iframe src="https://<?php echo VCITA_SERVER_BASE ?>/integrations/wordpress/settings" class="hidden" width="0" height="0"/>
    </script>
  <?php 
}
...
function vcita_widget_admin() {
  ...
  <div id="vcita_config" dir="ltr">
    ...
    <?php } 
      ...
      <br><br>
      <a class="gray-button-style preview" href="https://<?php echo VCITA_SERVER_BASE ?>/contact_widget?v=<?php echo vcita_get_uid() ?>&ver=2" data-width="200" data-height="500"><span></span>Preview</a>
    <?php } ?>      
  </div>
